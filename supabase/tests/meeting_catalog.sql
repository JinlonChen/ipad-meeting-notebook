...
select is((select count(*) from public.catalog_mutation_replays where user_id = '00000000-0000-4000-8000-000000000101' and operation_id = '00000000-0000-4000-8000-000000000201'), 1::bigint, 'successful mutation is persisted for replay');
...
select is((select count(*) from public.catalog_mutation_replays where user_id = '00000000-0000-4000-8000-000000000101' and operation_id = '00000000-0000-4000-8000-000000000207'), 1::bigint, 'missing folder removal is persisted for replay');
