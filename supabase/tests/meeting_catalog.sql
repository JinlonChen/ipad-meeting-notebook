...
select set_config('request.jwt.claim.sub', '00000000-0000-4000-8000-000000000101', true);
select is((public.apply_catalog_mutation('00000000-0000-4000-8000-000000000206', 'folder.remove', '00000000-0000-4000-8000-000000000301', '{"updatedAt":"2026-08-22T00:03:00Z","expectedSyncVersion":0}'::jsonb)->>'status')::int, 200, 'folder removal succeeds');
